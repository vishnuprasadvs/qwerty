...
const ContactUs = () => {
  emailjs.init("user_RCfupbJIozNE0Uo7R3iDi");
  const [isSentMsg , setSentMsg] = useState('');

      function submitForm(e){
        setSentMsg('')
        e.preventDefault();
        emailjs.sendForm('service_pybv9qr','template_59e9qgd', '#contact_us' , 'user_RCfupbJIozNE0Uo7R3iDi').then(res=>{
        // console.log(res);
      if(res.status === 200){
  ...
  return (
    <section className="contact_us_form mt-5">
      <div className="container">
          <div className="contact-us">
          <h1>Drop us a message!</h1>
          <div className="contact-wrap">
            <div className="drop-a-msg" >
                <form  id="contact_us" onSubmit={submitForm}>
                    <div className="prsnl-infrmtn" >
                      <fieldset>
                  ...
                  <div className="send_smg">{isSentMsg}</div>

                </form>
            </div>
            <div className="sns-and-address">
            <div className="address">
                    <h4>Address:</h4>
                    <h5>The ABC, P.O. Box 63, Abu Dhabi, UAE</h5>
                </div>
                <div className="address">
                    <h4>Social Media</h4>
